...
<body style="background-color: black;">
	<div class="container-fluid" style="background-image: url(getstart.jpg); height: 700px;  background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">  
		<h1 style="height: 250px;"></h1>
    <h1 style="text-align: center; color: red; font-family: Lucida Handwriting; ">Welcome to D Market</h1>
      <h2 style="text-align: center; color: white;  font-family: Fantasy Papyrus;  ">You want it, we got now <br>just go and get</h2>
      <h3 style=" font-size: 20px; text-align: center; color: gray; font-size: 30px; height: 30px;    " ><a href="#about">Get Started</a></h3>
      </div>
    <a name="about">
	...
	<div class="container-fluid" >
		...
		<div class = 'row'><div class="col-sm-1"></div>
			<div class = 'col-sm-4'>
				<a href="admin_login.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: dimgray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 80px; border : 1px; color: white;">&nbsp&nbsp  Admin &nbsp&nbsp</h1></a></button> 
			</div><div class="col-sm-2"></div>
			<div class = 'col-sm-4'>
				<a href="buyer.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: dimgray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 80px; border : 1; color: white;">&nbsp&nbsp Buyer &nbsp&nbsp</h1></a></button> 
			</div>
		...
		<div class="row">
			...
			</div></a></div></a></div></a></div></div></div></div></li></ul></nav></a>
