...
<body style="background-color: black;">
	...
	<div class="container" >
		<div class = 'row'>
			<div class = 'col-sm-6'>
				<a href="admin_add.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; border : 1px; color: white;">&nbsp&nbsp Add new Admin &nbsp&nbsp</h1></a></button> 
			</div>
			<div class = 'col-sm-6'>
				<a href="admin_view.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; border : 1; color: white;">&nbsp&nbsp&nbsp View all Admin &nbsp&nbsp&nbsp&nbsp</h1></a></button> 
			</div>

			<div class = 'col-sm-6'>
				<br><a href="add_items.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; border : 1; color: white;">&nbsp&nbsp&nbsp Add new items &nbsp&nbsp&nbsp</h1></a></button> 
			</div>
			<div class = 'col-sm-6'>
				<br><a href="view_items.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; border : 1; color: white;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp View items &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</h1></a></button> 
			</div>
			<div class = 'col-sm-6'>
				<br><a href="view_sold.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; ; color: white;">&nbsp&nbsp&nbsp&nbsp View purchase &nbsp&nbsp&nbsp</h1></a></button> 
			</div>
			
			<div class = 'col-sm-6'>
				<br><a href="view_pending.php"><button type="button" class="btn btn-link" style="border-style: inset; border-color: gray; border-width: 20px;border-radius: 20px;"><h1 style="font-size: 50px; border : 1; color: white;">&nbsp View pending order </h1></a></button> 
			</div>
