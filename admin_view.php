...
<body style="background-color: black;">
	...
	<div class="container-fluid" >
		<div class = 'row'>
			<div class="col-sm-12">
				<h1 style="color: red; font-size: 40px; text-align: center;"> Available Admin in our data base</h1>
	...
	?>
		<tr>
			...
			<td><?php echo $row['admin_phone_no'];?></td>
			<td><?php echo $row['admin_cnic'];?></td>
			<td><?php echo $row['admin_dob'];?></td>
			<td><?php echo $row['admin_qualification'];?></td>
