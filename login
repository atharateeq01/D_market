...
<body style="background-color: black;">
	...
	<ul class="navbar-nav ml-auto " style="color: blue; font-size: 20px; float: left;">
			<li class="nav-item" ><a href="session_destory.php" class="nav-link">Back </a></li>
		</ul>			
			</nav>
	...
	<div class="container" >
		<div class="row">
			<div class="col-6">
				<h1 style="color: red; font-size: 50px; text-align: left;">Let us sell </h1><br>
				<p style="color: white;font-size: 30px; ">"Noooo, there’s no way I, a mere handsome and sexy shopkeeper, could possibly have bankai!" ~ Tite Kubo</p>
			</div>	
				<div class="row">
					<div class="col-12" style="height: 10px;"></div>
					<h1 style="color: red; font-size: 40px; text-align: center;"> Identify yourself</h1>
					<div class="col-12" style="height: 30px;"></div>
					<form action="admin_login_insert.php" method="post">
					<div class="col-7">
						<h1 style="color: white; font-size: 30px; text-align: left;">E-mail</h1>
					</div>
					<div class="col-9">
						<input type="email" name="email"  placeholder="Enter email" >
					</div>
					<div class="col-3">
						<h1 style="color: white; font-size: 30px; text-align: left;">Password</h1>
					</div>
					<div class="col-9">
						<input type="Password" name="password"  placeholder="password" >
					</div>
					<div class="col-12"> 	</div>
					<div class="col-2"><input class="btn btn-primary" type="submit" value="Submit">	</div><
					</form>
				</div>		
				</div>
			</div>
