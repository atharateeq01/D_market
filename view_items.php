		...
		<div class="row">
			...
			?>				
				...
				<button style="border-style: double; border-color: gray; background-color: black; color: gray; height: 550px;"><h1 style="text-align: center;"> <?php echo $row['pro_name'];?></h1> 
					<?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['pro_pic']) .'" style="width:300px; height:200px;"/>'?><br><h1 style="font-size: 20px;">About: <?php echo $row['pro_discrip'];?></h1><br> <h1 style="font-size: 20px;">Rs. <?php echo $row['pro_price'];?></h1><br> <h1 style="font-size: 20px;">Remaining <?php echo $row['pro_qun'];?></h1><br><a href="product_delete.php?pro_id=<?php echo $row['pro_id'];?>">Delete</a><a href="product_update.php?pro_id=<?php echo $row['pro_id'];?>"> &nbsp&nbsp&nbsp Update</a></button>
			</div>
